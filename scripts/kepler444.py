...
def compute():
  ...
  # Estimate for JWST
  fig1, ax1 = jwst.estimate_eclipse_snr(tint = tdur, nout = nout, lammin = lammin, lammax = lammax,
                                        Tstar = Tstar, Tplan = Tplan, Rs = Rs, Rp = Rp, d = d)

  # Estimate for an OST-like telescope, but using the JWST filters
  fig2, ax2 = jwst.estimate_eclipse_snr(tint = tdur, nout = nout, lammin = lammin, lammax = lammax,
                                        Tstar = Tstar, Tplan = Tplan, Rs = Rs, Rp = Rp, d = d,
