...
def _test():
    ...
    Observer(ax[0])
    ax[0].set_title('Observer View', fontweight = 'bold', fontsize = 20)
    Side(ax[1])
    ax[1].set_title('Side View', fontweight = 'bold', fontsize = 20)
    Top(ax[2])
    ax[2].set_title('Top View', fontweight = 'bold', fontsize = 20)
    pl.show()
...
def Observer(ax, r = 1, theta = np.pi / 8, za = np.pi / 4):
    ...
    ax.annotate(r'$a$', xy = (x0, a / 2), ha = 'right', va = 'center', 
                xytext = (-10, 0), textcoords = 'offset points', fontsize = 18)
    ax.annotate(r'$b$', xy = (x0 + b / 2, 0), ha = 'center', va = 'top', 
                xytext = (0, -10), textcoords = 'offset points', fontsize = 18)
    ax.plot(x0, y0, 'ko')
    ax.annotate(r'$(x_0, 0)$', xy = (x0, y0), ha = 'right', va = 'top', 
                xytext = (-5, -5), textcoords = 'offset points', fontsize = 14)
    ylimb = (a / b) * np.sqrt(b ** 2 - (x0 - xlimb - x0) ** 2)
    ax.plot(x0 - xlimb, -ylimb, 'ro', zorder = 101)
    ax.plot(x0 - xlimb, ylimb, 'ro', zorder = 101)
    ax.plot(0, 0, 'ko')
    ax.annotate(r'$(0, 0)$', xy = (0, 0), ha = 'left', va = 'top', 
                xytext = (5, -5), textcoords = 'offset points', fontsize = 14)
...
def Side(ax, r = 1, theta = np.pi / 8, za = np.pi / 4):
    ...
    ax.annotate(r'$(0, 0)$', xy = (0, 0), ha = 'left', va = 'top', 
                xytext = (5, -5), textcoords = 'offset points', fontsize = 14)
    ax.annotate(r'$a$', xy = (-d, a / 2), ha = 'right', va = 'top', 
                xytext = (-10, 0), textcoords = 'offset points', fontsize = 18)
    ax.annotate(r'$r\cos\phi$', xy = (-d / 2, 0), ha = 'center', va = 'top', 
                xytext = (0, -10), textcoords = 'offset points', fontsize = 18)
    ax.annotate(r'$r$', xy = (-d / 2, a / 2), ha = 'center', va = 'top', 
                xytext = (15, 15), textcoords = 'offset points', fontsize = 18)
    x = np.linspace(-0.1, -0.0707107, 10000)
    y = np.sqrt(0.01 - x ** 2)
    ax.plot(x, y, 'k-', lw = 1)
    l = ax.annotate(r'$\phi$', xy = (-0.15, 0.1), ha = 'center', va = 'top', 
    ...
    ax.annotate("To star", xy = (-r * np.cos(za), a), xytext = (-122, 0), 
                fontsize = 16, ha = 'center', va = 'center', 
                annotation_clip = False, color = 'k',
                textcoords = "offset points", 
                arrowprops = dict(arrowstyle = "<|-", color = 'k'))
    
    ax.annotate("Zenith", xy = (-r * np.cos(za), a), 
                xytext = (-80, 80 * r * np.cos(za) / a), fontsize = 16,
                ha = 'center', va = 'center', annotation_clip = False, 
                color = 'k', textcoords = "offset points", 
                arrowprops = dict(arrowstyle = "<|-", color = 'k'))
    ...
    ax.plot(x, y, 'k-', lw = 1)
    l = ax.annotate(r'$\phi$', xy = (-r * np.cos(za), a), ha = 'center', 
                    va = 'top', xytext = (-24, 20), 
...
def Top(ax, r = 1, theta = np.pi / 8, za = np.pi / 4):
    ...
    ax.plot([x0 - b, x0 - xlimb], [np.sqrt(r ** 2 - (x0 - b) ** 2), 0], 
            'k--', lw = 1)
    ax.plot([x0 - xlimb, x0 + b], [0, -np.sqrt(r ** 2 - (x0 + b) ** 2)], 
            'k-', lw = 1)
    ...
    ax.fill_between(x, ybot, ytop, color = 'lightgray', zorder = 0, 
                    where = (ytop < np.sqrt(r ** 2 - x ** 2)))
    ax.fill_between(x, -ybot, ybot, color = 'lightgray', zorder = 0, 
                    where = (x < x0 - b))

    # Origin
    ax.plot(0, 0, 'ko')
    ax.annotate(r'$(0, 0)$', xy = (0, 0), ha = 'left', va = 'bottom', 
                xytext = (5, 5), textcoords = 'offset points', fontsize = 14)
    ...
    # a, b
    ax.plot([x0 + b, x0 + b], [-r * np.cos(za) * np.sin(theta), 
            -np.sqrt(r ** 2 - (x0 + b) ** 2)], 'k-', lw = 1)
    ax.plot([x0, x0 + b], [-r * np.cos(za) * np.sin(theta), 
            -r * np.cos(za) * np.sin(theta)], 'k-', lw = 1)
    ...
    ax.annotate("To star", xy = (-r * np.cos(theta), -r * np.sin(theta)), 
                xytext = (-66 * np.cos(theta), -66 * np.sin(theta)),
                ha = 'center', va = 'center', annotation_clip = False, 
                color = 'k', fontsize = 16, textcoords = "offset points", 
                arrowprops = dict(arrowstyle = "<|-", color = 'k'))
    
    ax.annotate(r'$r\cos\phi$', xy = (-0.32, -0.18), ha = 'center', 
                va = 'center', xytext = (12, -2), textcoords = 'offset points', 
                fontsize = 16)    
    ax.annotate(r'$x_0$', xy = (x0 / 2, 0), ha = 'center', va = 'center', 
                xytext = (0, 10), textcoords = 'offset points', fontsize = 16)
    ax.annotate(r'$b$', xy = (x0 + b / 2, -0.32), ha = 'center', va = 'center', 
                xytext = (0, -2), textcoords = 'offset points', fontsize = 16)
    ax.annotate(r'$x_\mathrm{limb}$', xy = (-0.707, 0.043), ha = 'center', 
                va = 'center', xytext = (0, 5), textcoords = 'offset points', 
                fontsize = 14, color = 'r')
    ax.annotate(r'$r$', xy = (0.28, -0.5), ha = 'center', va = 'center', 
                xytext = (0, 0), textcoords = 'offset points', fontsize = 16)
    ax.annotate(r'$a$', xy = (x0 + b / 2 - 0.05, -0.52), ha = 'right', 
                va = 'center', xytext = (0, -2), textcoords = 'offset points', 
                fontsize = 16)
    
    ax.annotate(r'$\theta$', xy = (0.0464, -0.23), ha = 'center', 
                va = 'center', xytext = (0, -5), textcoords = 'offset points', 
                fontsize = 16)
    ax.annotate(r'$\theta$', xy = (-0.225, -0.048), ha = 'center', 
                va = 'center', xytext = (0, 0), textcoords = 'offset points', 
                fontsize = 14)
    ax.annotate(r'$\theta$', xy = (-0.6786, -0.1286), ha = 'center', 
                va = 'center', xytext = (0, 0), textcoords = 'offset points', 
                fontsize = 12)
    ax.annotate(r'$\theta$', xy = (x0 + b, -np.sqrt(r ** 2 - (x0 + b) ** 2)), 
                ha = 'center', va = 'center', xytext = (-5, 28), 
    ...
    ax.plot([x0 + b - 0.03, x0 + b], [-r * np.cos(za) * np.sin(theta) - 0.03, 
             -r * np.cos(za) * np.sin(theta) - 0.03], 'k-', lw = 1) 
    ax.plot([x0 + b - 0.03, x0 + b - 0.03], 
            [-r * np.cos(za) * np.sin(theta) - 0.03, 
            -r * np.cos(za) * np.sin(theta)], 'k-', lw = 1) 
...
def Front(ax, r = 1, theta = np.pi / 8, za = np.pi / 4):
    ...
    ax.annotate(r'$a$', xy = (0, a / 2), ha = 'left', va = 'center', 
                xytext = (5, 0), textcoords = 'offset points', fontsize = 18)
    ax.annotate(r'$r$', xy = (-r / 2, 0), ha = 'center', va = 'top', 
                xytext = (0, -5), textcoords = 'offset points', fontsize = 18)
