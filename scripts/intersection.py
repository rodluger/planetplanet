...
def GetRootsNumerical(a, b, xE, yE, xC, yC, r):
    ...
    for xL, xR in zip(xLs, xRs):
        ...
        for sgnC, sgnE in zip(sgnCs, sgnEs):
            ...
            sL = np.sign(CircleMinusEllipse(xL, sgnC, xC, yC, r, 
                         sgnE, xE, yE, a, b))
            sR = np.sign(CircleMinusEllipse(xR, sgnC, xC, yC, r, 
                         sgnE, xE, yE, a, b))
            ...
            if sL != sR:
                ...
                # One root: easy
                x = brentq(CircleMinusEllipse, xL, xR, (sgnC, xC, yC, r, 
                           sgnE, xE, yE, a, b))
                roots.append(x)
                ...
                if sL > 0:
                    ...
                    res = minimize_scalar(CircleMinusEllipse, 
                                          bounds = (xL, xR), 
                                          args = (sgnC, xC, yC, r, sgnE, 
                                                  xE, yE, a, b), 
                                          method = 'bounded')
                    xmin = res.x
                    ymin = res.fun
                    ...
                    res = minimize_scalar(EllipseMinusCircle, 
                                          bounds = (xL, xR), 
                                          args = (sgnC, xC, yC, r, sgnE, 
                                                  xE, yE, a, b), 
                                          method = 'bounded')
                ...
                if np.sign(ymin) == sL:
                    ...
                    x = brentq(CircleMinusEllipse, xL, xmin, (sgnC, xC, yC, r, 
                               sgnE, xE, yE, a, b))
                    roots.append(x)
            
                    x = brentq(CircleMinusEllipse, xmin, xR, (sgnC, xC, yC, r, 
                               sgnE, xE, yE, a, b))
                    roots.append(x)
...
class Interactor(object):
    ...
    def __init__(self):
        ...
        self.el1, = self.ax.plot(x, 
                    yE - a / b * np.sqrt(b ** 2 - (x - xE) ** 2), 'k-', lw = 1)
        self.el2, = self.ax.plot(x, 
                    yE + a / b * np.sqrt(b ** 2 - (x - xE) ** 2), 'k-', lw = 1)
